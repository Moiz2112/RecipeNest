...
export const usePagination = ({
  ...
  useEffect(() => {
    console.log('[usePagination] Effect running:', {endpoint, sortOption, searchQuery, searchTrigger, currentPage: state.page, apiCurrentPage: state.apiCurrentPage});
    ...
    if (paramsChanged) {
      console.log('[usePagination] Parameters changed, resetting...');
    ...
    const shouldAbort = shouldAbortFetch(pageToFetch);
    console.log('[usePagination] shouldAbortFetch:', shouldAbort, {pageToFetch, loading: state.loading, totalPages: state.totalPages});
